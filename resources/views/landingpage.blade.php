...
@section('content')
    <div
        ...
        <div class="hero-section-left w-full lg:w-1/2 flex flex-col justify-center">
            <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">Platform Satu Hanya untuk
                Kamera, Gear Konten, dan Pembuat Konten di Bali</h1>
    ...
    <div class="about-us-container bg-[#0A4088] mt-10 lg:mt-14 flex items-center justify-center">
        <div
            ...
            <div class="about-us-right flex flex-col justify-center">
                <h1 class="text-white text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight">Semua Kebutuhan Rental Berada
                    di Satu Tempat</h1>
                ...
                <p
                    ...
                    Semua opsi rental di satu platform</p>
            </div>
        </div>
    </div>
        ...
        <div class="popular-product-wrapper px-6 sm:px-8 md:px-10 lg:px-14 py-10 sm:py-14 lg:py-20">
            ...
            <div class="text-center mb-8 sm:mb-10 lg:mb-14">
                ...
                <p class="text-gray-500 text-base sm:text-lg mt-3 sm:mt-4 max-w-2xl mx-auto">
                    Temukan kamera, gear, dan rental terpopuler di Bali yang paling banyak dipesan oleh pelanggan
                    Rentara.
                </p>
            </div>
                    ...
                    <div
                        ...
                        <div class="flex-1">
                            ...
                            <p
                                ...
                                Temukan fotografer profesional di Bali untuk menangkap momen Anda dan membuat
                                konten berkualitas tinggi dengan mudah.
                            </p>
                        </div>
                    ...
                    <div
                        ...
                        <div class="relative z-10 flex-1">
                            ...
                            <p class="text-white/80 group-hover:text-gray-600 text-sm sm:text-base mt-3 leading-relaxed">
                                Sewa tripods, kit pencahayaan, dan aksesori dari mitra rental lokal terpercaya
            ...
            <div class="mb-8 sm:mb-12 lg:mb-16 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
                <div>
                    ...
                    <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-black leading-tight">
                        Mengapa Sewa<br>di Rentara?
                    </h1>
                </div>
                <p class="text-gray-500 text-base sm:text-lg leading-relaxed max-w-sm md:text-right">
                    Sederhana, aman, dan terpercaya — platform penyewaan satu paket untuk Bali Anda.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 auto-rows-auto gap-5">
                ...
                <div
                    ...
                    <div class="relative z-10 mt-auto">
                        <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3">Verified Partners</h2>
                ...
                <div
                    ...
                    <div class="mt-4">
                        <h2 class="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Mudah Membandingkan harga</h2>
                ...
                <div
                    ...
                    <div class="mt-4">
                        <h2 class="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Cepat Booking melalui WhatsApp</h2>
                        <p class="text-gray-500 text-sm leading-relaxed">
    ...
    <div class="need-to-know bg-gray-50 py-10 sm:py-14 lg:py-20">
        <div class="need-to-know-wrapper px-6 sm:px-8 md:px-10 lg:px-14 max-w-6xl mx-auto">
            <div class="mb-8 sm:mb-10 lg:mb-12">
                <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-black mb-3 sm:mb-4 lg:mb-6">Sering Ditanyakan</h1>
                <p class="text-gray-500 text-base sm:text-lg md:text-xl leading-relaxed">Temukan jawaban dari pertanyaan yang sering diajukan kepada kami.</p>
            </div>
    ...
    <div class="our-latest-listing-container py-10 sm:py-14 lg:py-20">
        <div class="our-latest-listing-wrapper px-6 sm:px-8 md:px-10 lg:px-14 max-w-7xl mx-auto">
            <div class="mb-8 sm:mb-10 lg:mb-12">
                <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-black mb-3 sm:mb-4 lg:mb-6">Listing Produk Terbaru</h1>
                <p class="text-gray-500 text-base sm:text-lg md:text-xl leading-relaxed">Temukan kamera, gear, dan rental terbaru di Rentara.</p>
            </div>
