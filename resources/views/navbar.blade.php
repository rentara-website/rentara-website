<nav id="navbar" class="navbar-container sm:flex sm:items-center sm:justify-between w-full z-50 flex-col px-4 sm:px-6 md:px-10 py-2 bg-white transition-all duration-300">
