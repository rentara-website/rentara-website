...
@section('admin_content')
    <div class="space-y-6">
        <div class="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
            <h1 class="text-2xl font-black text-gray-900">Edit Category</h1>
            ...
            <form action="{{ route('admin.categories.update', $category->id) }}" method="POST">
                ...
                <div class="grid gap-4">
                    <div>
                        ...
                        <input type="text" class="w-full px-4 py-2 border border-gray-100 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#0A4088]/20 category-name" name="name" value="{{ $category->name }}">
                        @error('name')
