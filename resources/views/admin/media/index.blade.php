                ...
                @foreach($productImages as $image)
                    <div
                        ...
                        <div
                            ...
                            <form action="{{ route('admin.media.destroyImage', $image->id) }}" method="POST"
                ...
                @foreach($portfolios as $item)
                    <div
                        ...
                        <div class="absolute top-2 left-2">
                            @if($item->type === 'video')
                                <span
                                    class="bg-black/50 text-white text-[8px] px-2 py-0.5 rounded-full font-bold uppercase">Video</span>
                            @endif
                        </div>
                        ...
                        <div
                            ...
                            <form action="{{ route('admin.media.destroyPortfolio', $item->id) }}" method="POST"
