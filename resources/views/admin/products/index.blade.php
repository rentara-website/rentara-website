                                ...
                                <div class="flex items-center gap-4">
                                    <div class="w-12 h-12 bg-gray-50 rounded-xl overflow-hidden border border-gray-100 flex items-center justify-center shrink-0">
                                        @if($product->image_product->isNotEmpty())
                                            <img src="{{ Str::startsWith($product->image_product->first()->image_path, 'http') ? $product->image_product->first()->image_path : asset('storage/' . $product->image_product->first()->image_path) }}" 
