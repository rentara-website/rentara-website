    ...
    <div class="mt-10 px-14">
            ...
            <form action="" method="post">
                ...
                <div class="search-container mt-10">
                    <div class="relative w-4xl mx-auto">
                        <input type="search" name="search" id="search" placeholder="Search for products..." class="border border-gray-300 rounded-full px-4 py-2 pl-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-full shadow-md bg-white">
        ...
        <div class="list-products z-10 relative my-10">
            ...
            <div class="category bg-[#0A4088] rounded-lg p-5 w-60 text-center mb-10 flex items-center justify-center gap-3">
                <h3 class="font-bold text-white">Camera Equipment</h3>
            ...
            <div class="card-wrapper grid grid-cols-4 gap-2 ">
                ...
                <div class="card-container bg-[#EDEAEA] shadow-md rounded-lg p-5 max-w-sm mx-auto">
                    ...
                    <h2 class="text-[32px] font-bold uppercase">kd sony a6000</h2>
                    <h3 class="text-[20px] text-slate-500 uppercase">SONY A6000 LENS 16-50MM</h3>

                    <div class="price flex items-center justify-between mt-4">

                        <div>
                            <span class="text-[24px] font-bold text-[#0A4088]">Rp 150.000</span>

                            <span class="text-[16px] text-gray-500 line-through ml-2">Rp 200.000</span>
                        </div>

                        <div>
                            <a href="https://wa.me/6281938092473?text=Hi! I'm interested in renting the Sony A6000 lens" target="_blank">
            ...
            <div class="category bg-[#0A4088] rounded-lg p-5 w-60 text-center my-10 flex items-center justify-center gap-3">
                <h3 class="font-bold text-white">Camera Equipment</h3>
